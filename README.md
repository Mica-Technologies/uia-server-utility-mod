...
| [EvergreenHUD](https://github.com/Polyfrost/EvergreenHUD) by Polyfrost | GPL-3.0 | Reference for the HUD-element catalog. SUM's planned HUD elements (coords, FPS, time, biome, etc. — not yet ported) follow EvergreenHUD's pattern of one OneConfig HUD module per piece of information. No code reused (upstream is Kotlin, our target is Java + RetroFuturaGradle); the design is reused. |
